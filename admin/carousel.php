...
<div class="container-fluid" id="main-content">
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <button class="btn btn-dark shadow-none btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#carousel-s">
            ...
            <!--Carousel Modal -->
            <div class="modal fade" id="carousel-s" data-bs-keyboard="true" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
