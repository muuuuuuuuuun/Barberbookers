...
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-md-6 mb-5 px-4">
            ...
            <iframe class="w-100 rounded mb-4" width="600" height="320px" src="<?php echo $contact_r['iframe'] ?>" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <h5>Address</h5>
                <a href="<?php echo $contact_r['gmap'] ?>" target="_blank" class="d-inline-block text-decoration-none text-dark">
                    <i class="bi bi-geo-alt-fill"></i> <?php echo $contact_r['address'] ?>
                </a>
                <h5 class="mt-4">Call us if you have any problem!</h5>
